...
import { Truck, Driver, Load, Hub, Tenant, Client } from "@/app/lib/types";
        ...
        <Card className="lg:col-span-8 border-none shadow-sm overflow-hidden h-[550px] relative">
                ...
                <Marker key={client.id} position={[client.address.lat!, client.address.lng!]} icon={clientIcon}>
                  <Popup>
                    <div className="p-1">
                      ...
                      <div className="mt-2 text-[10px] font-bold uppercase text-slate-400">Industria: {client.industry}</div>
                    </div>
                  </Popup>
                </Marker>
              ))}
          ...
          <div className="absolute top-4 left-4 z-[500] space-y-2 pointer-events-none">
            <div className="bg-white/90 backdrop-blur p-3 rounded-lg border shadow-sm text-[10px] font-bold uppercase space-y-2 pointer-events-auto">
              <div className="flex items-center gap-2 text-blue-600"><div className="w-2 h-2 rounded-full bg-blue-600"></div> Camiones en Tránsito</div>
              ...
              <div className="flex items-center gap-2 text-green-600"><div className="w-2 h-2 rounded-full bg-green-600"></div> Clientes / Dadores</div>
            </div>
          </div>
        </Card>
